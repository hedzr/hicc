...
namespace hicc::exception {
    ...
    class hicc_exception : public std::runtime_error {
    ...
    public:
        hicc_exception(const char *file, int line, const std::string &arg)
        ...
        ~hicc_exception() noexcept override = default;
...
#define hicc_throw_line(arg) throw hicc::exception::hicc_exception(__FILE__, __LINE__, arg)

    class hicc_biz_error : public hicc_exception {
    public:
        using hicc_exception::hicc_exception;
    };

#define hicc_throw_as(typ, ...) throw hicc::exception::typ(__FILE__, __LINE__, __VA_ARGS__)
...
#define HICC_DUMP_STACK_TRACE(e) hicc::debug::dump_stacktrace(__FILE__, __LINE__, e)
#define HICC_DUMP_WITHOUT_STACK_TRACE(e) hicc::debug::dump_stacktrace(__FILE__, __LINE__, e, false)
