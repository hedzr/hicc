...
#ifndef HICC_CXX_HZ_TERMINAL_HH
#define HICC_CXX_HZ_TERMINAL_HH
...
namespace hicc::terminal::colors {
...
#undef DEF_MODIFIER
    ...
    public:
        ...
        colorize &fg(int r, int g, int b) {
            // HICC_ASSERT(c >= 0 && c <= 256);
            _fg = (r << 16) | (g << 8) | b;
            _true_color_enabled = true;
            return (*this);
        }
        colorize &fg(Colors256 color256) {
            // HICC_ASSERT(color256 >= 0 && color256 <= 256);
            _fg = (int) color256;
    ...
    public:
        ...
        //
        //    using namespace hicc::terminal::colors;
