...
inline std::ostream &operator<<(std::ostream &os, const hicc::chrono::iom::fmtflags v) {
    using iom = hicc::chrono::iom;
    iom::set_flags(v);
    return os;
}
...
inline std::ostream &operator<<(std::ostream &os, T const &v) {
    return hicc::chrono::format_duration(os, v);
}
...
inline std::ostream &operator<<(std::ostream &os, std::chrono::time_point<_Clock, _Duration> const &time) {
    // std::size_t ns = hicc::chrono::time_point_get_ns(time);
    return hicc::chrono::serialize_time_point(os, time, "%F %T");
}

inline std::ostream &operator<<(std::ostream &os, std::tm const *tm) {
    return hicc::chrono::serialize_tm(os, tm, "%F %T");
}
inline std::ostream &operator<<(std::ostream &os, std::tm const &tm) {
    return hicc::chrono::serialize_tm(os, &tm, "%F %T");
}

inline std::ostream &operator<<(std::ostream &os, hicc::chrono::clock const &v) {
    return v.serialize(os, "%F %T");
}


#endif //HICC_CXX_HZ_CHRONO_HH
