...
void test_pq() {
    ...
    hicc::queue::priority_queue<std::string, int, pq_comp> pq;
    ...
    std::cout << "DUMP..." << '\n';
    pq.dump([](hicc::queue::priority_queue<std::string, int, pq_comp>::element *el) {
    ...
    hicc::queue::priority_queue<std::string, int, pq_comp,
                                hicc::queue::priority_queue<std::string, int, pq_comp>>
            pq2;
    ...
    std::cout << "- DUMP..." << '\n';
    pq2.dump([](hicc::queue::priority_queue<std::string, int, pq_comp,
                                            hicc::queue::priority_queue<std::string, int, pq_comp>>::element *el) {
        for (auto const &it : el->_list) {
            std::cout << it << ',';
        }
        std::cout << '\n';
